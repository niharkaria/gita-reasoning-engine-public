...
# Ensure `gita_engine` is importable when Alembic is run from repo root.
sys.path.insert(0, str(Path(__file__).resolve().parents[1] / "src"))

from gita_engine.core.config import get_settings  # noqa: E402
from gita_engine.db.models import Base  # noqa: E402
