  ...
  export function CitationCard({ citation }: { citation: CitedPassage }) {
    ...
    return (
      <div className="relative border-l-2 border-brass bg-white/40 pl-5 pr-4 py-4 rounded-r-md">
        ...
        >
          <span
            className="inline-flex items-center justify-center min-w-[2.75rem] h-7 px-2 rounded-full border border-brass text-brasstext-xs font-medium font-body tracking-wide"
